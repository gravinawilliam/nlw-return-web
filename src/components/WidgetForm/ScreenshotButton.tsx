...
export function ScreenshotButton(props: ScreenshotButtonProps) {
  ...
  return (
    <button
      type="button"
      className="p-2 bg-zinc-800 rounded-md border-transparent hover:bg-zinc-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
